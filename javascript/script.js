...
function reset1()
{
	...
	document.getElementById("button1").innerHTML = "<button id=TerminatorButton>show more</button><button class='purchaseButton'>Purchase</button>";
	document.getElementById("TerminatorButton").addEventListener("click", TerminatorShowMore);
	addEventListeners();
}
...
function reset2()
{
	...
	document.getElementById("button2").innerHTML = "<button id=VacutronButton>show more</button><button class='purchaseButton'>Purchase</button>";
	document.getElementById("VacutronButton").addEventListener("click", VacutronShowMore);
	addEventListeners();
}
...
function reset3()
{
	...
	document.getElementById("button3").innerHTML = "<button id=SuckmasterButton>show more</button><button class='purchaseButton'>Purchase</button>";
	document.getElementById("SuckmasterButton").addEventListener("click", SuckmasterShowMore);
	addEventListeners();
}
...
{
	document.getElementById("button1").innerHTML = "<button id=TerminatorButton>Show less</button><button class='purchaseButton'>Purchase</button>";
...
{
	document.getElementById("button2").innerHTML = "<button id=VacutronButton>Show less</button><button class='purchaseButton'>Purchase</button>";
...
{
	document.getElementById("button3").innerHTML = "<button id=SuckmasterButton>Show less</button><button class='purchaseButton'>Purchase</button>";
